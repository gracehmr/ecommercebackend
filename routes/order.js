...
router.put("/:id", async (req, res) => res.status(200).json({msg: "Update One Order", data: await editOrder(req.params.id, req.body.name, req.body.qty, req.body.price, req.body.product)}));
