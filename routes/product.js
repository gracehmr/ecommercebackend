...
router.put("/:id", async (req, res) => res.status(200).json({msg: "Update One Product", data: await editProduct(req.params.id, req.body.name, req.body.description, req.body.price, req.body.imageUrl)}));
